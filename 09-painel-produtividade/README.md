# Painel de Produtividade — Power BI
...
Nenhum dado real da empresa foi utilizado.

| Arquivo | Conteúdo |
|---------|----------|
| demandas.csv | 420 demandas · Jan 2024–Jun 2025 |
| squads.csv | 8 squads por área |
| status.csv | 5 status de demanda |
| prioridade.csv | 4 níveis com SLA em dias |
| categoria.csv | 6 tipos de demanda |
| responsaveis.csv | 24 analistas · 3 por squad |
