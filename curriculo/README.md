# 📋 Currículo — Patricia Vasconcelos

**Arquivo:** `curriculo-patricia-vasconcelos.pdf`
...
**Dados & BI**
Power BI · SQL · Power Query · Databricks (conceitual)

**Gestão & PMO**
Jira · ServiceNow (ITSM/SPM) · Scrum · Kanban
OKRs · KPIs · MoSCoW · TAP · Gestão de Riscos

**Governança**
Data Governance · LGPD · DAMA-DMBOK (em estudo)

**IA**
ChatGPT · Engenharia de Prompts · Microsoft Copilot
...
| PSM I — Scrum.org | ⏳ Fev/2027 |
| PL-300 — Microsoft | ⏳ Mar/2027 |

---

*Para o plano completo de certificações, veja [`roteiro/`](../roteiro/)*
